...
function getUrlPattern() {
	...
	return path.replace(/\{([^}]+)\}/g, function (match, group) {
		var value = bbmnUtils.getByPath(_this, group);
		return value;
	});
}
...
var index$9 = (function (Base) {
	...
	var mixin = bbmnUtils.isModelClass(Base) ? ModelMixin(Base) : bbmnUtils.isCollectionClass(Base) ? CollectionMixin(Base) : throwError();
...
exports.createAsPromiseMixin = index$16;
