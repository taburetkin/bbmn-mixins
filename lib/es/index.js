...
import { betterResult, buildViewByKey, getByPath, getOption, isCollection, isCollectionClass, isKnownCtor, isModelClass, mergeOptions } from 'bbmn-utils';
import $ from 'jquery';
...
var index$7 = (function (Base) {
	return Base.extend({
		...
		setupNestedEntity: function setupNestedEntity(key, entity) {
		...
		_setNestedEntityHandlers: function _setNestedEntityHandlers(context) {
			...
			if (!context.onEntityChange) {
				context.onEntityChange = function (instance) {
					var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
					    syncChange = _ref.syncChange;

					!syncChange && _this2.set(name, entity.toJSON(), { syncChange: true });
				};
			}
			...
			if (!context.onPropertyChange) {
				context.onPropertyChange = function (instance, _newvalue, _ref2) {
					var syncChange = _ref2.syncChange;
		...
		destroy: function destroy() {
			...
			var superDestroy = Base.prototype.destroy;
			return superDestroy && superDestroy.apply(this, arguments);
		},
		_disposeEntities: function _disposeEntities() {
			var _this3 = this;

			_.each(this._nestedEntities, function (context) {
				return _this3._disposeEntity(context);
			});
...
export { index as emptyFetchMixin, index$1 as emptyViewMixin, index$2 as improvedIndexesMixin, index$3 as nextCollectionViewMixin, index$4 as customsMixin, index$5 as improvedFetchMixin, index$6 as childrenableMixin, index$7 as nestedEntitiesMixin, index$8 as smartGetMixin, index$9 as saveAsPromiseMixin, index$11 as cssClassModifiersMixin, index$13 as nestedViewsMixin, index$12 as destroyViewMixin, index$10 as buildViewByKeyMixin };
