			...
			if (!context.onPropertyChange) {
				context.onPropertyChange = function (instance, _newvalue, _ref2) {
					...
					if (isModel(entity)) {
						...
						entity.set(val, { unset: true, silent: true, changeInitiator: changeInitiator });
					}
				};
			}
