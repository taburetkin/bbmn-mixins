(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('bbmn-core'), require('bbmn-utils'), require('jquery'), require('backbone.marionette')) :
	typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'bbmn-core', 'bbmn-utils', 'jquery', 'backbone.marionette'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.mixins = {}),global._,global.bbmn,global.bbmn.utils,global.$,global.Mn));
}(this, (function (exports,_,bbmnCore,bbmnUtils,$,backbone_marionette) { 'use strict';
		...
		buildCustom: function buildCustom(view) {
			...
			if (bbmnCore.isViewClass(view)) {
				...
				if (bbmnCore.isView(view.view)) {
					...
					var viewOptions = _.extend({}, childOptions, view.options);
		...
		_setNestedEntityHandlers: function _setNestedEntityHandlers(context) {
			...
			if (!context.onPropertyChange) {
				context.onPropertyChange = function (instance, _newvalue, _ref2) {
					...
					if (bbmnUtils.isModel(entity) && changeInitiator != entity) {
					...
					} else if (bbmnUtils.isCollection(entity) && changeInitiator != entity) {
...
exports.smartGetMixin = index$11;
exports.saveAsPromiseMixin = index$12;
exports.cssClassModifiersMixin = index$14;
exports.nestedViewsMixin = index$16;
exports.destroyViewMixin = index$15;
exports.buildViewByKeyMixin = index$13;
exports.scrollHandlerMixin = index$17;
exports.createAsPromiseMixin = index$18;
