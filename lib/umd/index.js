...
var index$11 = (function (Base) {
  ...
  */
		...
		_initRenderOnModelChange: function _initRenderOnModelChange() {
			...
			var shouldRefresh = this.getOption('renderOnModelChange', { args: [this] });
			var shouldTriggerRefresh = this.getOption('renderOnModelChange', { args: [this] });
			var shouldInvoke = this.getOption('renderOnModelChange', { args: [this] });
